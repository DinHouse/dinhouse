...
const Booking = () => {
  ...
  return (
    <div className='bg-greenPrimary -mt-2 pt-16 text-center pb-20'>
        <h1 className='font-Brawler text-2xl lg:text-7xl text-base-100 drop-shadow-md mb-10'>Pesan Sekarang <br/> Dapatkan Harga Spesial!!!</h1>
        {discount.isDiscount && <h2 className='font-Brawler bg-error w-fit mx-auto px-5 text-base-100 rounded-full py-1 mb-7 lg:text-2xl animate-pulse'>Penawaran Terbatas</h2>}
        ...
        {discount.isDiscount & timeLeft.difference > 0 ? (
            ...
            <div className="flex flex-col p-2 bg-base-100 rounded-box text-error font-Brawler">
        ...
        <form className='px-3 flex-row space-y-5 lg:w-2/4 mx-auto' onSubmit={handleBooking}>
            ...
            <button type='submit' className='bg-[#000] px-7 py-2 rounded-full text-base-100 font-Brawler'>Cek Ketersediaan</button>
        </form>
    </div>
  )
}
